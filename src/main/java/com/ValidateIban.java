...
public interface ValidateIban {
    ...
    @Action(input = "http://soap/ValidateIban/validateRequest", output = "http://soap/ValidateIban/validateResponse")
    ...
    @Action(input = "http://soap/ValidateIban/ValidateIbanRequest", output = "http://soap/ValidateIban/ValidateIbanResponse")
    ...
    @Action(input = "http://soap/ValidateIban/validateListRequest", output = "http://soap/ValidateIban/validateListResponse")
