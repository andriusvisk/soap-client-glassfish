 ...
 * 
 */
@WebServiceClient(name = "ValidateIbanService", targetNamespace = "http://soap/", wsdlLocation = "http://localhost:8080/ibanValidation/ValidateIbanService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/ibanValidation/ValidateIbanService?wsdl");
